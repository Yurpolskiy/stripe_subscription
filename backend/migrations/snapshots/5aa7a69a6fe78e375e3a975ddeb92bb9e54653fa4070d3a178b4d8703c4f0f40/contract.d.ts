...
export type StorageHash =
  StorageHashBase<'5aa7a69a6fe78e375e3a975ddeb92bb9e54653fa4070d3a178b4d8703c4f0f40'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Subscription: {
      ...
      readonly status: 'ACTIVE' | 'CANCELED' | 'PAST_DUE' | 'TRIALING' | 'INCOMPLETE' | 'UNPAID';
        ...
        readonly entries: {
          readonly table: {
            readonly subscription: {
              ...
              uniques: readonly [{ readonly columns: readonly ['stripeSubscriptionId'] }];
              indexes: readonly [
                {
